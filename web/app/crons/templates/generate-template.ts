    ...
    messages: [
      {
        ...
        Ideally the template should not be much longer than the How to Apply section of the flow description. Above all else, make it very similar to the How to Apply section of the flow description, make the language incredibly simple, and do not include many words. 
        `,
      },
